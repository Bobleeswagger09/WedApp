...
export default function ContactPage() {
  return (
    <section className="min-h-screen bg-gradient-to-tr from-rose-50 via-white to-rose-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 px-6 py-20 text-gray-800 dark:text-gray-100">
